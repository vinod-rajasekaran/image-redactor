...
def main() -> None:
    ...
    path = datasets.save(
        ...
        truth,
        {
            "description": "10 synthetic Indian documents generated by this "
                           "project plus 10 photographs, hand-labelled.",
            "licence": "project-internal; may contain real PII — never commit",
            "annotation": "text (legibility scoring)",
        },
    )
    print(f"Wrote {path}")
