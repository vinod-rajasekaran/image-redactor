...
**97.2% of core PII redacted** — 70 of 72 items across 20 documents,
...
because it pulls in torch: with it, they go from 0/5 to 5/5 and the
overall figure is **97.4%** (75/77); without it, 90.9%.

The two remaining core leaks are a name and a phone number on a single
photographed form.
...
|---|---|---|
| `documents/` — drawn here | no | 97.2% core redacted |
